...
export default function Hero({
  ...
  microDetails = ["Mobile‑first design", "Real‑time tracking", "Secure platform"]
}) {
  ...
  return (
    <section ref={sectionRef} className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col items-start gap-6 px-6 pb-24 pt-36 sm:gap-8 sm:pt-44 md:px-10 lg:px-16">
          ...
          {ctaButtons.map((button, index) => (
            <button
              ...
              onClick={() => {
                if (button.onClick) {
                  button.onClick();
                } else if (button.href === '/login') {
                  window.location.href = button.href;
                } else if (button.href === '/signup') {
                  window.location.href = button.href;
                }
              }}
